...
public class InputModelFactory {
    ...
    public static nz.net.charge.eway.rapid.sdk.beans.internal.Customer createInternalCustomer() {
        nz.net.charge.eway.rapid.sdk.beans.internal.Customer cust = new nz.net.charge.eway.rapid.sdk.beans.internal.Customer();
    ...
    public static List<nz.net.charge.eway.rapid.sdk.beans.internal.Customer> createListInternalCustomer() {
        List<nz.net.charge.eway.rapid.sdk.beans.internal.Customer> listCustomer = new ArrayList<>();
    ...
    public static TransactionSearchResponse createTransactionSearchResponse() {
        ...
        response.setError("");
        nz.net.charge.eway.rapid.sdk.beans.internal.Transaction[] trans = {createInternalTransaction()};
        response.setTransactions(trans);
        return response;
    }

    public static nz.net.charge.eway.rapid.sdk.beans.internal.Transaction createInternalTransaction() {
        nz.net.charge.eway.rapid.sdk.beans.internal.Transaction transaction = new nz.net.charge.eway.rapid.sdk.beans.internal.Transaction();
